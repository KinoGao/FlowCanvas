...
import { Check, ChevronRight, Clapperboard, Download, Eye, EyeOff, FileText, Globe, Grid2x2, Image as ImageIcon, Layers3, ListChecks, Maximize2, Music2, PenTool, Search, SlidersHorizontal, StickyNote, Type, Video, Workflow } from "lucide-react";
...
const NODE_FILTER_VALUES: string[] = ["all", CanvasNodeType.Image, CanvasNodeType.Video, CanvasNodeType.Text, CanvasNodeType.Annotation, CanvasNodeType.Whiteboard, CanvasNodeType.WebPreview, CanvasNodeType.Collage, CanvasNodeType.Audio, CanvasNodeType.Script, CanvasNodeType.Clip, CanvasNodeType.ComfyUI, CanvasNodeType.Config, CanvasNodeType.Group];

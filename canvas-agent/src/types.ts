...
export type CanvasNodeType = "image" | "text" | "comfyui" | "video" | "audio";
...
export type CanvasConnection = { id: string; fromNodeId: string; toNodeId: string; referenceOrder?: number };

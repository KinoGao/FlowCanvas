# LibTV、TapNow、小云雀与 FlowCanvas 节点 UI / 交互动效视觉证据册

> 取证日期：2026-08-11
> 证据类型：公开页面截图、官方材料截图、GIF、FlowCanvas 本地现场操作、代码动效参数核验
> 配套主文档：[LibTV、TapNow 与小云雀无限画布交互调研](2026-08-11-libtv-tapnow-xiaoyunque-interaction-research.md)
...
本册把截图、GIF、节点操作清单和现场缺陷放在一起。图片均保存在仓库内，不依赖临时浏览器会话。
